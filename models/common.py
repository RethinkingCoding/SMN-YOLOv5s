...
class ChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=16):
        ...
        self.relu = nn.ReLU()
        # self.frelu = FReLU(in_planes // ratio)
    ...
    def forward(self, x):
        ...
        # avg_out = self.f2(self.frelu(self.f1(self.avg_pool(x))))
        # max_out = self.f2(self.frelu(self.f1(self.max_pool(x))))
...
class SpatialAttention(nn.Module):
    def __init__(self, kernel_size=7):
        ...
        assert kernel_size in (3, 7), 'kernel size musts be 3 or 7'
